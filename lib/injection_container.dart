...
import 'features/data/data_sources/remote_data_source/remote_data_source_impl.dart';
...
import 'features/domain/usecases/firebase_usecases/user/get_single_other_usecase.dart';
...
import 'features/domain/usecases/firebase_usecases/user/sign_out_user_usecase.dart';
...
Future<void> init() async {
  ...
  sl.registerLazySingleton(() => CreateUseCase(repository: sl.call()));
